...
<head>
    ...
    <title>Edit Loan | Riski Aquaria</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card p-4">
                                <h3 class="text-center">Edit Detail Loan</h3>
                                <hr>
                                <form class="mt-3">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input type="date" value="30" class="form-control"
                                                    id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <a href="detailLoan.php" class="btn btn-danger">Batal</a>
                                    </div>
