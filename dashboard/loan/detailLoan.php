...
<head>
    ...
    <title>Detail Loan | Riski Aquaria</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card p-4">
                                <h3 class="text-center">Detail Loan</h3>
                                <hr>
                                <form class="mt-3">
                                    <div class="form-group">
                                                <label for="exampleInputEmail1">Loan Amount</label>
                                                <input type="number" value="RA516M" class="form-control"
                                                    id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
                                            </div>
                                    <div class="form-group">
                                                <label for="exampleInputEmail1">Start Date</label>
                                                <input type="date" value="Anemones" class="form-control"
                                                    id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
                                            </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">End Date</label>
                                        <input type="date" value="Red Fire Anemon" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-right">
                                        <a href="editLoan.php" class="btn btn-warning">Edit</a>
