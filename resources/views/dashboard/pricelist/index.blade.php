        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray-800"><a href="/dashboard/">Dashboard</a> / Pricelist</h1>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td>
                                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pricelist.destroy', $pricelist->id) }}" method="POST">
                                                            <a href="{{ route('pricelist.show', $pricelist->id) }}" class="btn btn-sm btn-dark"><i class="fa fa-eye"></i></a>
                                                            <a href="{{ route('pricelist.edit', $pricelist->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-alt"></i></a>
                                                            @csrf
                                                            @method('DELETE')
