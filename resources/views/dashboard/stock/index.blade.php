    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray-800"><a href="/dashboard/" class="text-decoration-none">Dashboard</a> / Stock List</h1>
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            ...
                                            @forelse ($stock as $stock)
                                                <tr class="odd">
                                                    ...
                                                    <td>{{ $stock->clientContact }}</td>
                                                    <td>{{ $stock->clientEmail }}</td>
                                                    <td> {{ $stock->clientAddress }}</td>
                                                    <td>
                                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('stock.destroy', $stock->id) }}" method="POST">
                                                            <a href="{{ route('stock.show', $supplier->id) }}" class="btn btn-sm btn-dark"><i class="fa fa-eye"></i></a>
                                                            <a href="{{ route('stock.edit', $supplier->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-alt"></i></a>
                                                            @csrf
                                                            @method('DELETE')
